...
describe("testando formatadores", () => {
    describe("testando formatador do fitgirl", () => {
        const fitGirlGames = [
        ...
        test("deve formatar os jogos corretamente", () => {
    ...
    describe("testando formatador do kaoskrew", () => {
        const kaosKrewGames = [
    ...
    describe("testing formatador do empress", () => {
        const empressGames = [
    ...
    describe("testando formatador do kodi", () => {
        const dodiGames = [
